    ...
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-amber-50 via-amber-50 to-amber-100 px-4">
      ...
      >
        ...
        <div className="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          ...
          {showDataInfo && (
            <div className="mt-3 text-xs text-blue-900 space-y-2 border-t border-blue-200 pt-3">
              <p><strong>Name (First & Last):</strong> Identifies you in the system and aid correspondence</p>
              <p><strong>Email:</strong> For account access, password recovery, and official communications</p>
              <p><strong>Phone:</strong> For emergency contact and aid disbursement coordination</p>
              <p><strong>University:</strong> To verify eligibility and connect you with your institution's resources</p>
              <p><strong>Password:</strong> Securely encrypts your account to prevent unauthorized access</p>
              <p className="pt-2 italic">We only collect what's necessary to verify your identity and process aid applications.</p>
            </div>
          )}
        </div>
        ...
        <div className="mb-5 p-3 bg-amber-50 border border-amber-200 rounded-lg">
          <label className="flex items-start gap-2 cursor-pointer">
            ...
            <span className="text-sm text-gray-700">
              I understand that WeCare collects my name, email, phone, and university information to verify my identity, process aid requests, and send official communications. 
              <button
                type="button"
        ...
        <button
          ...
          className="w-full py-3 bg-amber-700 text-white font-semibold rounded-xl shadow-md hover:bg-amber-800 transition transform hover:-translate-y-1 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          Register
        </button>
